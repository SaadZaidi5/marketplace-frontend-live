...
export function LoginForm() {
  ...
  return (
    <>
      {/* Desktop Layout */}
      <div
        className="hidden md:flex h-screen w-screen items-center justify-center fixed inset-0"
        style={{
      ...
      >
        ...
        {toast && (
          <div
            className={`fixed top-5 right-5 px-4 py-3 rounded-lg shadow-lg z-50 ${
        ...
        <div className="flex w-full max-w-5xl overflow-hidden rounded-2xl shadow-2xl bg-gray-800">
          {/* Left Panel - Branding */}
          <div className="flex w-1/2 flex-col items-center justify-center bg-blue-500 p-12 text-white">
          ...
          <div className="w-1/2 bg-gray-900 p-16">
      ...
      {/* Mobile Layout */}
      <div
        className="md:hidden fixed inset-0 w-screen h-screen bg-gray-900 overflow-y-auto"
        ...
        <div className="bg-blue-600 p-6 text-center">
          <div className="flex items-center justify-center gap-3 mb-3">
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <g clipPath="url(#clip0_6_319_mobile)">
                <path
                  d="M8.57829 8.57829C5.52816 11.6284 3.451 15.5145 2.60947 19.7452C1.76794 23.9758 2.19984 28.361 3.85056 32.3462C5.50128 36.3314 8.29667 39.7376 11.8832 42.134C15.4698 44.5305 19.6865 45.8096 24 45.8096C28.3135 45.8096 32.5302 44.5305 36.1168 42.134C39.7033 39.7375 42.4987 36.3314 44.1494 32.3462C45.8002 28.361 46.2321 23.9758 45.3905 19.7452C44.549 15.5145 42.4718 11.6284 39.4217 8.57829L24 24L8.57829 8.57829Z"
                  fill="currentColor"
                />
              ...
              <defs>
                <clipPath id="clip0_6_319_mobile">
                  <rect fill="white" height="48" width="48" />
                </clipPath>
              </defs>
            </svg>
